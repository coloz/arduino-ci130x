...
uint8_t SdFile::open(SdFile* dirFile, const char* fileName, uint8_t oflag) {
  ...
  // set timestamps
  if (dateTime_) {
    // dir_t is packed.  Use aligned locals for callbacks because CI13XX is
    // a RISC-V target and a callback may perform halfword stores.
