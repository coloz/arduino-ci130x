...
*/
  ...
  // CI13XX uses the core's GPIO software SPI implementation.  Keep these
  // aliases in the utility layer because the upstream SdFat code expects
  // the traditional Arduino pin names even though it transfers through
  // SPIClass rather than touching registers directly.
