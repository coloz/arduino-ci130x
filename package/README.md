...
The version-pinned `v1.0.15` index is also published as a GitHub Release asset:
...
For version 1.0.15, `.github/workflows/deploy-release.yml` downloads
...
.\package\build_package.ps1 `
  ...
  -RequireAllHostTools `
  -Version 1.0.15 `
  -BaseUrl https://github.com/OWNER/arduino-ci130x/releases/download/v1.0.15 `
...
remains `9.2.0`. Version 1.0.15 requires public
...
`arduino-ci130x-1.0.15/`. Put the contents of `arduino-ci130x`
...
`x86_64-pc-linux-gnu`. Version 1.0.15 declares `citool-cli@1.2.2`
