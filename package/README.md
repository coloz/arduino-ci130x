...
The version-pinned `v1.0.12` index is also published as a GitHub Release asset:

```text
https://github.com/coloz/arduino-ci130x/releases/download/v1.0.12/package_chipintelli_index.json
```
...
For version 1.0.12, `.github/workflows/deploy-release.yml` downloads
...
.\package\build_package.ps1 `
  ...
  -RequireAllHostTools `
  -Version 1.0.12 `
  -BaseUrl https://github.com/OWNER/arduino-ci130x/releases/download/v1.0.12 `
...
remains `9.2.0`. Version 1.0.12 requires public
...
`arduino-ci130x-1.0.12/`. Put the contents of `arduino-ci130x`
...
`x86_64-pc-linux-gnu`. Version 1.0.12 declares `citool-cli@1.2.2`
